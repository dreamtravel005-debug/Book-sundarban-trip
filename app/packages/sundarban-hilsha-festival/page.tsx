...
export default function SundarbanFinalPage() {
  ...
  const slides = [
    { text: "2 Night 3 Days", image: "/images/packages/sundarbanhilshafestivale2.jpg" },
    { text: "The Wild Nature", image: "/images/packages/sundarban-hilsa-festivel.jpg" },
  ...
  const packages = [
    {
      ...
      price: "3,499",
      oldPrice: "4,000",
      features: ["Canning To Canning", "Boat Safari (Sajnekhali)", "All Meals (Bengali)", "Certified Guide", "Science City Pickup"],
      accent: "bg-blue-600",
      popular: false
    },
    {
      name: "Kolkata To Kolkata Plan",
      price: "5,999",
      oldPrice: "7,500",
      features: ["Kolkata To Kolkata", "Deep Jungle Safari", "Buffet Menu + Snacks", "Expert Guide", "Home/Hotel Pickup"],
      accent: "bg-green-600",
      popular: true
    },
    {
      ...
      price: "10,999",
      oldPrice: "12,000",
      features: ["Premium Resort Stay", "Boat Safari", "Seafood Special Menu", "Evening Folk Show", "kolkata to Kolkata pickup & drop"],
  ...
  const foodMenu = [
    {
      day: "Day 01",
      menu: [
        { type: "Welcome Drink", items: "Cold Drinks" },
        { type: "Welcome Snacks", items: "Amudey Farry" },
        { type: "Lunch", items: "Rice, Dal, Bhaja, Kachusakh Ilish, Chingri Curry, Sorsey Ilish, Salad, Chutney, Papad" },
        { type: "Evening Snacks", items: "Chicken Pakora / Veg Pakora with Tea/Coffee" },
        { type: "Dinner", items: "Fried Rice, Mix Sabji & Chicken Kosa, Chatni" }
      ]
    },
    {
      day: "Day 02",
      menu: [
        ...
        { type: "Lunch", items: "Rice, Dal, Bhaja,  Pui Ilish, Doi Ilish, Vetki / Pabda, Salad, Chutney, Papad" },
        { type: "Evening Snacks", items: "French Fries or Chowmein with Tea/Coffee" },
        { type: "Dinner", items: "Rice/Roti, Veg Curry, Mutton Curry, Salad" }
      ]
    },
    {
      day: "Day 03",
      menu: [
        { type: "Breakfast", items: "Nan Puri, Alu Kosa, Misti, Tea/coffee" },
        { type: "Lunch", items: "Ilish Biriyani, Chiken-Chap, Salad" },
        { type: "Departure", items: "Special Tea & Sweets during return journey" }
      ]
    }
  ];
  ...
  const itinerary = [
    {
      ...
      activities: [
        { time: "11:30 AM", detail: "Reach Godkhali (the gateway) and board our Tourist motorboat." },
        { time: "01:30 PM", detail: "Enjoy a freshly cooked lunch on the boat while cruising through the scenic waterways." },
        { time: "04:00 PM", detail: "Visit the Bird Jungle to witness a breathtaking sunset over the forest." },
    ...
    },
    {
      ...
      activities: [
        { time: "08:00 AM", detail: "Board the safari boat and head to the Sajnekhali Tiger Reserve (government guide included)." },
        { time: "10:00 AM", detail: "Thrilling cruise through Pirkhali and Gajikhali creeks; visit Sudhanyakhali Watch Tower for a chance to spot tigers, crocodiles, and spotted deer." },
        { time: "01:00 PM", detail: "Delicious lunch served on the boat amidst the forest silence." },
        { time: "03:00 PM", detail: "Visit Do-Banki Tiger Reserve for the famous 896-meter Canopy Walk, viewing wildlife from a protected height, Then Back to the ResortHotel." },
        { time: "10:00 PM", detail: "Dinner and relaxation at the resort." }
      ]
    },
    {
      day: "Day 03",
      ...
      activities: [
        ...
        { time: "11:00 AM", detail: "Visit Hamilton House & Beacon Bungalow." },
        { time: "01:30 PM", detail: "Farewell Grand Lunch and packing up." },
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6 max-w-4xl">
          ...
          <p className="text-gray-200 text-lg md:text-xl font-light mb-10 max-w-2xl mx-auto">
            Sundarban Ilish Utsab – A delightful festival celebrating Hilsa with delicious dishes, scenic river views, and cultural programs, making it a unique monsoon attraction.
          </p>

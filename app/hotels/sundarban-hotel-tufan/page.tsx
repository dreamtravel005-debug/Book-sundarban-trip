...
export default function HotelDetailedPage() {
  ...
  // 1. HOTEL DATABASE
  const hotelData: any = {
    "sundarban-hotel-tufan": {
      name: "Sundarban Hotel Tufan",
      ...
      images: [
        ...
        "/images/hotels/hotel-tufan/hotel-tufan2.jpg",
        "/images/hotels/hotel-tufan/hotel-tufan3.jpg",
        "/images/hotels/hotel-tufan/hotel-tufan4.jpg",
        "/images/hotels/hotel-tufan/hotel-tufan5.jpg",
      ],
      description: `Hotel Tufan – A budget-friendly and comfortable hotel in the Sundarbans, offering clean rooms, essential amenities, and warm service. Its convenient location near the river makes it a popular choice for travelers looking for an affordable yet pleasant stay experience.`,
      rooms: [
        { id: 1, type: "Deluxe 4 Beads Room", price: "1,899", area: "240 sq ft", bed: "2 Queen Bed", perks: "Free Breakfast", badge: "Best Seller" },
        { id: 3, type: "Super Deluxe Family Suite", price: "2,499", area: "240 sq ft", bed: "2 King Beds", perks: "Pool Access + All Meals", badge: "Best Value" },
      ],
      reviews: [
  ...
  const hotel = hotelData[slug as string] || hotelData["sundarban-hotel-tufan"];

...
export default function HotelDetailedPage() {
  ...
  const hotelData: any = {
    "Sundarban-Rk-Resort": {
      ...
      images: [
        ...
        "/images/hotels/Rk-resort/Rk-resort3.jpg",
        "/images/hotels/Rk-resort/Rk-resort4.jpg",
        "/images/hotels/Rk-resort/Rk-resort5.jpg",
      ],
      description: `Sundarban Rk Resort – A premium and comfortable resort set amidst the natural beauty of the Sundarbans, offering a perfect blend of lush mangroves, tranquil rivers, and modern amenities. With spacious rooms, authentic Bengali cuisine, and warm hospitality, it is an ideal choice for a peaceful and relaxing getaway.`,
      rooms: [
        { id: 1, type: "Deluxe Double Room", price: "3,499", area: "280 sq ft", bed: "1 King Bed", perks: "Free Breakfast", badge: "Best Seller" },
        { id: 2, type: "Deluxe Family Room", price: "3,999", area: "280 sq ft", bed: "2 King Bed", perks: "Free Breakfast", badge: "Highly Rated" },
      ],
      reviews: [
  ...
  const hotel = hotelData[slug as string] || hotelData["Sundarban-Rk-Resort"];

...
export default function HotelDetailedPage() {
  ...
  // 1. HOTEL DATABASE
  const hotelData: any = {
    "Sundarban-Apanjan-Hotel": {
      name: "Sundarban Apanjan Tourism",
      ...
      images: [
        ...
        "/images/hotels/Apanjan-hotel/apanjanhotel4.jpg",
        "/images/hotels/Apanjan-hotel/apanjanhotel5.jpg",
        "/images/hotels/Apanjan-hotel/apanjanhotel6.jpg",
      ],
      description: `Sundarban Apanjan Hotel – A budget-friendly and comfortable hotel set in the peaceful surroundings of the Sundarbans, offering clean rooms, essential amenities, and warm hospitality. Its convenient location makes it a popular choice for travelers seeking an affordable and pleasant stay.`,
      rooms: [
        { id: 1, type: "Deluxe Double Room", price: "1,799", area: "140 sq ft", bed: "1 Queen Bed", perks: "Free Breakfast", badge: "Best Seller" },
        { id: 2, type: "Deluxe Family Room", price: "1,999", area: "140 sq ft", bed: "1 King Bed", perks: "Free Breakfast", badge: "Highly Rated" },
      ],
      reviews: [
  ...
  const hotel = hotelData[slug as string] || hotelData["Sundarban-Apanjan-Hotel"];

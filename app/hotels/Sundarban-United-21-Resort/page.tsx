...
export default function HotelDetailedPage() {
  ...
  // 1. HOTEL DATABASE
  const hotelData: any = {
    "Sundarban-United-21-Resort": {
      name: "Sundarban United 21 Resort",
      ...
      images: [
        ...
        "/images/hotels/Sundarban-United-21-Resort/United-21 Resort1.jpg",
        ...
        "/images/hotels/Sundarban-United-21-Resort/United-21 Resort5.jpg",
        "/images/hotels/Sundarban-United-21-Resort/United-21 Resort6.jpg",
      ],
      description: `Sundarban United 21 Resort – A modern and comfortable resort set in the scenic surroundings of the Sundarbans, offering a perfect blend of nature and contemporary amenities. With spacious rooms, authentic Bengali cuisine, and warm hospitality, it is an ideal choice for a relaxing stay and exploring the beauty of the Sundarbans.`,
      rooms: [
  ...
  const hotel = hotelData[slug as string] || hotelData["Sundarban-United-21-Resort"];

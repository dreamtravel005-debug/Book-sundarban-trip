...
export default function HotelDetailedPage() {
  ...
  const hotelData: any = {
    "Sundarban-beckons": {
      ...
      images: [
        ...
        "/images/hotels/Sundarban-beckons-resort/beckons3.jpg",
        "/images/hotels/Sundarban-beckons-resort/beckons.jpg",
        "/images/hotels/Sundarban-beckons-resort/beckons5.jpg",
      ],
      description: `Sundarban Beckons Resort – A premium and comfortable resort set amidst the natural beauty of the Sundarbans, offering a perfect blend of lush mangroves, tranquil rivers, and modern amenities. With spacious rooms, authentic Bengali cuisine, and warm hospitality, it is an ideal choice for a peaceful and relaxing getaway.`,
      rooms: [
        { id: 1, type: "Deluxe Double Room", price: "2,499", area: "280 sq ft", bed: "1 Queen Bed", perks: "Free Breakfast", badge: "Best Seller" },
        { id: 2, type: "Deluxe Family Room", price: "2,999", area: "350 sq ft", bed: "1 King Bed", perks: "River View + Breakfast", badge: "Highly Rated" },
      ],
      reviews: [
  ...
  const hotel = hotelData[slug as string] || hotelData["Sundarban-beckons"];

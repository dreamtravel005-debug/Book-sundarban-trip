...
export default function HotelDetailedPage() {
  ...
  const hotelData: any = {
    "luxury-forest-resort": {
      name: "Luxury Forest Resort Sundarban",
      ...
      images: [
        "/images/hotels/Sundarban-sonarbangla/sonarbangla.webp",
        "/images/hotels/Sundarban-sonarbangla/sonarbangla (1).webp",
        "/images/hotels/Sundarban-sonarbangla/sonarbangla2.jpg",
        "/images/hotels/Sundarban-sonarbangla/sonarbangla3.jpg",
        "/images/hotels/Sundarban-sonarbangla/sonarbangla5.jpg",
        "/images/hotels/Sundarban-sonarbangla/sonarbangla.jpg",
      ],
      description: `Sonar Bangla, Sundarban – A peaceful and picturesque destination nestled in the heart of the Sundarbans, where winding rivers, lush mangrove forests, and authentic rural life come together. Visitors can enjoy boat rides, bird watching, local culture, and a close connection with nature. Away from the noise of the city, it offers the perfect escape for relaxation and experiencing the true essence of the Sundarbans.`,
      rooms: [
        { id: 1, type: "Deluxe Double Room", price: "8,599", area: "140–180 sq ft", bed: "1 Queen Bed", perks: "Free Breakfast", badge: "Best Seller" },
        { id: 2, type: "Premium River View Room", price: "10,999", area: "180–220 sq ft", bed: "1 King Bed", perks: "River View + Breakfast", badge: "Highly Rated" },
        { id: 3, type: "Super Deluxe Family Suite", price: "14,999", area: "200–260 sq ft", bed: "2 King Beds", perks: "Pool Access + All Meals", badge: "Best Value" },
      ],
      reviews: [
  ...
  const hotel = hotelData[slug as string] || hotelData["luxury-forest-resort"];
